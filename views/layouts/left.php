        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => 'Глобальный рейтинг', 'url' => ['/rating/global']],
                    ['label' => 'Рейтинг команд', 'url' => ['/rating/teams']],
                    ['label' => 'О компании', 'url' => ['/company/index']],
                    //['label' => 'Структура компания', 'url' => ['/company/structure']],
                    ['label' => 'Новости', 'url' => ['/news/index']],
                    ['label' => 'Медиа', 'url' => ['/media/index']],
                    ['label' => 'Полезные документы', 'url' => ['/documents/index']],
